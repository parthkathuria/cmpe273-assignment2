...
public class LibraryService extends Service<LibraryServiceConfiguration> {
	...
	private void Listener() throws JMSException {
		...
		if (libraryName.equals("library-a"))
			destination = arg(0, "/topic/31112.book.*");
		else if (libraryName.equals("library-b"))
			destination = arg(0, "/topic/31112.book.computer");
	...
	public void updateBookRepository(String bookReceived) {
